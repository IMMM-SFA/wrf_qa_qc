...
from find_outliers import iqr_test
...
def wrf_stats(input_path: str, output_path: str, start: str, stop: str,
    ...
    for month in months:
        ...
        normality_output_filename = os.path.join(year_path + "/" + f"tgw_wrf_hourly_{month}_normality.nc")

        # save each output stat as a netCDF file
        stats_combined.to_netcdf(path=stats_output_filename)
        normality_ds.to_netcdf(path=normality_output_filename)
